...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-0 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
...
const SheetFooter = ({
  ...
  <div
    className={cn("flex flex-col-reverse gap-2 px-4 py-3 sm:flex-row", className)}
    {...props}
  />
);
